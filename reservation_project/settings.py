...
EMAIL_HOST_USER = 'spaconfortrent@gmail.com' #correo de la cuenta de Gmail
EMAIL_HOST_PASSWORD = 'msgh mrua dttv qdwi' #clave de aplicación, no la contraseña de la cuenta
